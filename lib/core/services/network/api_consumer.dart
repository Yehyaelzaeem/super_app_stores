...
class ApiConsumer {
  ...
  Future<Response> post({
    ...
    final String? token = await _cacheConsumer.getSecuredData(StorageKeys.kToken);
  ...
  Future<Response> get({
    ...
    final String? token =
        await _cacheConsumer.getSecuredData(StorageKeys.kToken);
  ...
  Future<Response> delete({
    ...
    return await _dio.delete(
      ...
      data: requestBody,
      options: Options(
        headers: {_authorization: token != null ? "Bear $token" : Constants.empty},
      ),
    );
  }
}
