        ...
        children: [
          if (widget._isHorizontal)...[
            ...
            if (widget._label != null)...[
              Expanded(flex: 2,child: Text(widget._label!, style: const TextStyle().regularStyle().customColor( widget._isDark?Theme.of(context).cardColor:Theme.of(context).hintColor),)),
            ]
          ],
