...
class CompeteDataWidget extends StatelessWidget {
  const CompeteDataWidget({super.key, this.height, this.title, this.image});
  final double? height;
  final String? title;
  final String? image;
  @override
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      height: 60.h,
                      child: Center(
                        child: Text(title??LocaleKeys.completeData.tr(),
                                          ...
                                          children: [
                                                           ...
                                                           child: InkWell(
                                                             ...
                                                             child: Container(
                                                               ...
                                                               child:
                                                                 ...
                                                                 child:  Center(
                                                                   child:
                                                                   image!=null?CustomImage(image: image??'',radius: 30,
                                                                   width: 150.w,
                                                                     height:120.w,
                                                                   ):
                                                         ...
                                                         Container(
                                                           ...
                                                           child: CustomElevatedButton(
                                                             ...
                                                             onTap: (){
                                                               cubit.completeProfile(context,image!=null?true:false);
                                                             },
                                                             buttonText:image!=null?LocaleKeys.update.tr():LocaleKeys.done.tr(),
                                                             width: MediaQuery.of(context).size.width,
                                                             height: 40,
                                                             fontSize: 17,
                                                             borderRadius: 40,
