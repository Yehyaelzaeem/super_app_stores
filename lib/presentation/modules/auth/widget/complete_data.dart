  ...
  void initState() {
    if (profile == null) {
      ...
      cubit.comNameArController =
          TextEditingController(text: profile?.store?.nameAr ?? '');
      cubit.comNameController =
          TextEditingController(text: profile?.store?.name ?? '');
    }
    ...
    cubit.categoryModelDataList = [
      CategoryModel(
          id: storeTypeCategory?.id ?? 0, name: storeTypeCategory?.name ?? '')
    ];
    super.initState();
  }
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            widget.title ?? LocaleKeys.completeData.tr(),
                            ...
                            Column(
                              children: [
                                CustomTextField(
                                  ...
                                  hintStyle: TextStyles.font16Black500Weight
                                      .copyWith(
                                          color: Colors.grey.shade500,
                                          fontWeight: FontWeight.w600),
                                  fillColor: backGroundGray,
                                        ...
                                        onTap: () {
                                          if (context
                                            ...
                                            Navigator.push(
                                                    ...
                                                    MaterialPageRoute(
                                                        builder: (context) =>
                                                            PickUpGoogleMapScreen()))
                                                .then((value) {
                                              cubit.addressModel = value;
                                              cubit.pickUpController.text =
                                                  '${cubit.addressModel?.city ?? ''}/${cubit.addressModel?.street ?? ''}/${cubit.addressModel?.bigCity ?? ''}';
                                            });
                                          } else {
                                            context
                                                .read<LocalAuthCubit>()
                                ...
                                RestaurantTypesWidget(
                                  onChanged: (DropModel value) {
                                    cubit.comTypeController.text =
                                        value.id.toString() ?? '';
                                    print(
                                        'cccc : ${cubit.comTypeController.text}');
                                  },
                                ),
                                verticalSpace(13),
                            ...
                            builder: (context, state) {
                              return Column(
                                children: [
                                  ...
                                  Container(
                                    decoration:
                                        Decorations.backGroundDecorationButton()
                                            .copyWith(
                                                borderRadius:
