            ...
            BlocConsumer<HomeCubit, HomeState>(
              ...
              builder: (context, state) {
                if (cubit.homeModel != null &&
                    cubit.homeModel!.categories != null &&
                    cubit.homeModel!.categories!.data!.isNotEmpty) {
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          LocaleKeys.categoreis.tr(),
                          style: TextStyles.font20Black700Weight
                              .copyWith(color: backBlue2, fontSize: 20),
                        ),
                        verticalSpace(10),
            ...
            Row(
              children: [
                ...
                Text(
                  LocaleKeys.meals.tr(),
                  style: TextStyles.font20Black700Weight
                      .copyWith(color: backBlue2, fontSize: 15),
                ),
                horizontalSpace(5),
                ...
                Container(
                  ...
                  decoration: Decorations.backGroundDecorationButton().copyWith(
                    ...
                    topRight: Radius.circular(
                        context.locale.languageCode.toString() == 'ar'
                            ? 25
                            : 0),
