...
class FileDoneWidget extends StatelessWidget {
  const FileDoneWidget({super.key, required this.title, required this.text, required this.onTap});
  final String title;
  final String text;
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  // const Icon(Icons.file_upload_outlined,color: customGray,),
                  // horizontalSpace(10),
