...
class AddAccountFilesUseCase implements BaseUseCase<dynamic>{
  final AccountRepository repository;
  AddAccountFilesUseCase({required this.repository});
  Future<ResponseModel> call({required AccountFilesBody accountFilesBody }) async {
    return BaseUseCaseCall.onGetData<dynamic>( await repository.addAccountFiles( accountFilesBody: accountFilesBody), onConvert,tag: 'AccountFilesUseCase');
  }
