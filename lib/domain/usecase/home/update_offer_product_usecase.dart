...
class UpdateOfferProductUseCase implements BaseUseCase<dynamic>{
  final HomeRepository repository;
  UpdateOfferProductUseCase({required this.repository});
  Future<ResponseModel> call({required AddProductBody addProductBody,required int id}) async {


    return BaseUseCaseCall.onGetData<dynamic>( await repository.updateOfferProductUseCase(addProductBody: addProductBody, id: id), onConvert,tag: 'UpdateOfferProductUseCase');
  }
