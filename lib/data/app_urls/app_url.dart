...
class AppURL {
  ...
  static String kDeleteBranchURL({required int branchId}) =>
      "stores/branches/delete_branch/$branchId";
  static String kUpdateBranchURL({required int branchId}) =>
      "stores/branches/update_branch/$branchId";
  ...
  static String kDeleteProductURL({required int id}) =>
      "stores/products/remove_product/$id";
  static String kChangeProductStateURL({required int id}) =>
      "stores/products/change_status?id=$id";
  static String kUpdateProductURL({required int id}) =>
      "stores/products/update_product/$id";
  static String kUpdateOfferProductURL({required int id}) =>
      "stores/offer/update_product/$id";
  static const String kAddProductURL = "stores/products/add_product";
  static const String kAddOfferProductURL = "stores/offer/add";

  ///more
  static const String kGetPrivacyURL = "privacy";
  ...
  static const String kSendPricePrescriptionURL =
      "stores/prescriptions/add-price";
  ...
  static String kCategoriesItemsURI(
          {required int categoryId, required int storeId}) =>
      "stores/categories?category_id=$categoryId&store_id=$storeId";
  ...
  static const String kAddDeliveryTimeURL =
      "stores/profile/store-delivery-time";

  /// order
  static String kAllOrdersURL(
          {required String status,
          required int page,
          required String branchId}) =>
      "stores/orders/status?status=$status&page=$page&branch_id=$branchId";
  static const String kAcceptOrderURL = "stores/orders/accept-order";
  static String kRejectOrderURL({required int id}) =>
      "stores/orders/reject_order/$id";
  static String kChangeRestaurantStateURL = "stores/profile/change_status";
  static String kGetOrdersByDateStateURL({required String date}) =>
      "stores/orders/date/$date";
  static String kInProgressOrderURL({required int id}) =>
      "stores/orders/progress-order/$id";
  static String kDeliveredOrderURL({required int id}) =>
      "stores/orders/delivered-driver-order/$id";
  static String kFinishOrderURL({required int id}) =>
      "stores/orders/done-order/$id";
